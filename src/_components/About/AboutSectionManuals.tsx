              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List
                    text="Manual de configuración de Microsoft Outlook, Success Factors, Microsoft Teams y Service Now Mobile."
                    url = "https://amiable-tapir-788.convex.cloud/api/storage/4a51f3b5-f31e-4cf3-91a4-7d649fc4b940"
                    />
