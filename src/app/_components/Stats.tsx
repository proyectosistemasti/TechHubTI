          ...
          <div className="md:7/12 lg:w-1/2">
            ...
            <div className="space-y-4 divide-y divide-gray-100 dark:divide-gray-800">
              <div className="flex gap-4 mt-8 md:items-center">
                <div className="flex w-12 h-12 gap-4 bg-indigo-100 rounded-full dark:bg-indigo-900/20">
                ...
                <div className="w-5/6">
                  <h4 className="text-lg font-semibold text-gray-700 dark:text-indigo-300">Chat Anytime</h4>
              ...
              <div className="flex gap-4 pt-4 md:items-center">
                <div className="flex w-12 h-12 gap-4 bg-teal-100 rounded-full dark:bg-teal-900/20">
                ...
                <div className="w-5/6">
                  <h4 className="text-lg font-semibold text-gray-700 dark:text-teal-300">Real Time Location</h4>
                  <p className="text-gray-500 dark:text-gray-400">Asperiores nemo possimus nesciunt quam mollitia.</p>
                </div>
              </div>
            </div>
